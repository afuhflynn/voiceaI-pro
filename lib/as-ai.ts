...
//     apiKey: "3f0d016cd8ff45408bda3e0b0118b2fb", // Replace with your chosen API key, this is the "default" account api key
//   });
...
// Install required packages "npm install ws mic"
import WebSocket from "ws";
import mic from "mic";
import querystring from "querystring";
import fs from "fs";
// --- Configuration ---
const YOUR_API_KEY = "3f0d016cd8ff45408bda3e0b0118b2fb"; // Replace with your chosen API key, this is the "default" account api key
...
const API_ENDPOINT =
  "${API_ENDPOINT_BASE_URL}?${querystring.stringify(CONNECTION_PARAMS)}";
...
function setupTerminationHandlers() {
  ...
  process.on("SIGINT", () => {
    console.log("Ctrl+C received. Stopping...");
    cleanup();
