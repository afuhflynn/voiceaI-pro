...
export default function VoiceAgentPage() {
  ...
  const initializeAudioContext = useCallback(() => {
    if (typeof window !== "undefined" && !audioContextRef.current) {
      try {
        ...
        setError(
          "Failed to initialize audio. Please check your browser permissions."
        );
      }
    }
  }, []);
  ...
  const test = async () => {
    const ex: KnowledgeEntity = {
      id: "cl0x8a2b3001234567890abcde",
    ...
    // run();
    const res = await getAIResponse(ex);
            ...
            {/* <div className="space-y-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground text-xl max-w-3xl mx-auto leading-relaxed">
                  Explore conversation analytics, manage your knowledge
                  repository, and fine-tune your AI assistant's behavior
                </p>
              </div>
                  ...
                  <Card className="border-0 shadow-2xl bg-card/60 backdrop-blur-xl">
                    <CardHeader>
                      ...
                      <CardDescription className="text-base">
                        Customize your AI assistant's domain expertise and
